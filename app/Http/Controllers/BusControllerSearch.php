    ...
    public function bookbus(Request $request)
    {
        try {
            ...
            if (isset($requestData['Passenger'])) {
                $requestData['passenger'] = array_map(function ($passenger) {
                    return [
                        ...
                        'Email' => $passenger['Email'], // Use provided email
                        ...
                        'IdNumber' => $passenger['IdNumber'] === 'null' ? null : $passenger['IdNumber'],
            ...
            $validatedData = $request->validate([
                ...
                'passenger.*.IdNumber' => 'string|nullable',
            ...
            Log::info('Sending email to: ' . $primaryPassenger['Email']);
